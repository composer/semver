...
class VersionParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function successfulNormalizedVersions()
    {
        return array(
            ...
            'delimiters' => array('1.0.0.RC.15-dev', '1.0.0.0-RC.15-dev'),
            ...
            'parses long/semver' => array('10.4.13beta.2', '10.4.13.0-beta.2'),
            ...
            'semver metadata/2' => array('1.0.0-beta.5+foo', '1.0.0.0-beta.5'),
            'semver metadata/3' => array('1.0.0+foo', '1.0.0.0'),
            'semver metadata/4' => array('1.0.0-alpha.3.1+foo', '1.0.0.0-alpha.3.1'),
            'semver metadata/5' => array('1.0.0-alpha2.1+foo', '1.0.0.0-alpha2.1'),
            // not supported for BC 'semver metadata/6' => array('1.0.0-0.3.7', '1.0.0.0-0.3.7'),
            // not supported for BC 'semver metadata/7' => array('1.0.0-x.7.z.92', '1.0.0.0-x.7.z.92'),
    ...
    public function caretConstraints()
    {
        return array(
            ...
            array('^1.2', new Constraint('>=', '1.2.0.0-dev'), new Constraint('<', '2.0.0.0-dev')),
            array('^1.2.3-beta.2', new Constraint('>=', '1.2.3.0-beta.2'), new Constraint('<', '2.0.0.0-dev')),
