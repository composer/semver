...
class VersionParserTest extends TestCase
{
    ...
    public function constraintProvider()
    {
        return array(
            ...
            array('~1.1,!=1.1.1', '[>= 1.1.0.0-dev < 2.0.0.0-dev != 1.1.1.0]'),
            array('~1.1,>=1.1.1', '[>= 1.1.1.0-dev < 2.0.0.0-dev]'),
            array('~2.5.9|~2.6,>=2.6.2', '[[>= 2.5.9.0-dev < 2.6.0.0-dev] || [>= 2.6.2.0-dev < 3.0.0.0-dev]]'),
        );
    }
